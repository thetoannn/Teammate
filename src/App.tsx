  ...
  return (
    <ThemeProvider>
      ...
      <Routes>
        ...
        />
        <Route
          path="/final-history-page"
          element={<FinalHistoryPage />}
        />
      
        <Route path="/update-package-month" element={<UpdatePackageMonth />} />
        ...
        <Route
          ...
          element={
            <div className="flex flex-col w-screen h-screen">
              ...
              <div className="flex-1 p-6">
                <div className="max-w-4xl mx-auto">
                  <h1 className="text-2xl font-bold mb-6">ComfyUI Settings</h1>
                  <div className="text-center">
                    <p className="text-gray-600">
