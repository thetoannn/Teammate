        ...
        <div className="flex flex-col h-full">
            ...
            <div className="mb-[27px]">
              ...
              >
                <div className="icon text-[29px] block text-white flex justify-center items-center">
                  <img
                    className="duration-300 ease-in-out group-hover:scale-[1.2] w-[38px] h-[38px]"
                    src={brandLogoMain}
                    alt="logo-company"
                  />
                </div>
          ...
          <div className="mt-auto">
            <button
              ...
              } flex items-center justify-center leading-[27px] mb-1 ml-1 relative box-border rounded-full w-[30px] h-[30px] group hover:scale-105 transition-transform duration-300 ease-in-out cursor-pointer px-[5px] ${
            ...
            <div
              className={`text-white flex items-center justify-center ml-[2px] whitespace-nowrap text-[9px] ${
                planName === "Free" || planName === "Plus" ? "mr-[7px]" : ""
              }`}
            >
